...
public class TrainBookingService {
    ...
    public List<Train> searchTrains(String source, String destination) {
        return trainList.stream().filter(train -> train.getStations().contains(source) && train.getStations().contains(destination)
        && (train.getStations().indexOf(source) < train.getStations().indexOf(destination))).toList(); 
    }
